...
player_images = []
for i in range(1, 5):
    player_images.append(pygame.transform.scale(pygame.image.load(f'Project packman/PythonPacman/assets/player_images/{1}.png'), (45, 45)))
blinky_img = pygame.transform.scale(pygame.image.load(f'Project packman/PythonPacman/assets/ghost_images/red.png'), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(f'Project packman/PythonPacman/assets/ghost_images/pink.png'), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load(f'Project packman/PythonPacman/assets/ghost_images/blue.png'), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load(f'Project packman/PythonPacman/assets/ghost_images/orange.png'), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load(f'Project packman/PythonPacman/assets/ghost_images/powerup.png'), (45, 45))
dead_img = pygame.transform.scale(pygame.image.load(f'Project packman/PythonPacman/assets/ghost_images/red.png'), (45, 45))
player_x = 450
player_y = 663
direction = 0
blinky_x = 56
